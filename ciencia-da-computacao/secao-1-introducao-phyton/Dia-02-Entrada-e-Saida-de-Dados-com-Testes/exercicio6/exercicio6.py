# Realize esse exercício utilizando TDD: implemente
#  os testes e depois a função 🧪
...
# 🦜 As funções isalpha, isdigit e isnumeric podem
#  ser utilizadas para verificar se uma letra ou palavra
# são compostas de somente caracteres ou dígitos.
